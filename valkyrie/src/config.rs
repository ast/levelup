//! User config at `$XDG_CONFIG_HOME/valkyrie/config.toml`. Palette/layout/loader
//! come from `levelup_tui::config`; only valkyrie's fields live here.
...
pub struct Colors {
    ...
    /// Transient action messages and the hold-to-kill meter.
...
pub fn load_or_default() -> Config {
    levelup_tui::config::load_or_default(levelup_core::xdg::config_file("valkyrie"))
}
